...
pandoc -f latex -s -o test.html.tmp test.tex --mathjax=https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-AMS-MML_HTMLorMML --bibliography=test.bib
